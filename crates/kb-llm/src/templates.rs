...
impl Template {
    ...
    fn bundled(name: &str) -> Result<String> {
        match name {
            ...
            "ask_auto.md" => Ok(include_str!("../prompts/ask_auto.md").to_string()),
            ...
            "merge_concept_candidates.md" => {
                Ok(include_str!("../prompts/merge_concept_candidates.md").to_string())
            }
            "concept_body.md" => Ok(include_str!("../prompts/concept_body.md").to_string()),
            ...
            "filter_concept_suggestions.md" => {
                Ok(include_str!("../prompts/filter_concept_suggestions.md").to_string())
            }
            _ => Err(anyhow!(
